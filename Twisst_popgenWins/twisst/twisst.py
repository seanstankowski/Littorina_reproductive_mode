...
try:
        ...
        found = False
sys.stderr.write("argparse: " + str(found) + " \n") 
...
try:
        ...
        found = False
sys.stderr.write("itertools: " + str(found) + " \n")
...
try:
        ...
        found = False
sys.stderr.write("gzip: " + str(found) + " \n")


try:
        imp.find_module('ete3')
        found = True
except ImportError:
        found = False
sys.stderr.write("ete3: " + str(found) + " \n")


try:
        imp.find_module('random')
        found = True
except ImportError:
        found = False
sys.stderr.write("random: " + str(found) + " \n")
...
try:
        ...
        found = False
sys.stderr.write("numpy: " + str(found) + " \n")
...
try:
        ...
        found = False
sys.stderr.write("collections: " + str(found) + " \n")
