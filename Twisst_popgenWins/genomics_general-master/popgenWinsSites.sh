...
srun --cpu_bind=verbose python /nfs/scistore03/bartogrp/sstankow/TopologyWeightingFiles/TwisstScripts/genomics_general-master/popgenWindows.py --windType sites --windSize 100 --overlap 0  -p Egglayer -p Brooder -g arc_sax.geno.gz -o popgenOut.csv.gz -f phased -T 5 --popsFile pops.txt
